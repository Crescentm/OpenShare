...
func buildHandlers(
	...
	return &routeHandlers{
		...
		imports:            imports.NewImportHandler(services.imports, services.adminAuth, importSyncNotifier, services.searchIndex),
		moderation:         moderation.NewModerationHandler(services.moderation, services.searchIndex),
		...
		resourceManagement: resources.NewResourceManagementHandler(services.resourceManagement, services.adminAuth, services.searchIndex),
		search:             search.NewSearchHandler(services.search),
		searchIndex:        search.NewSearchIndexHandler(services.searchIndex),
